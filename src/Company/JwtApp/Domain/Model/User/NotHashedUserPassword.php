...
class NotHashedUserPassword extends UserPassword
{
...
//        }
    ...
    public function equalTo(NotHashedUserPassword $passwordUtente): bool
    {
        return $this->password === $passwordUtente->password();
    }
}
